    ...
    <div dir="ltr" className="[unicode-bidi:plaintext]">
      ...
      <BasicPage>
        <div>
          ...
          <p className="b1 mb-4">If you have any questions about this CSAE policy please contact <a href="mailto:legal@joinmastodon.org" className="font-semibold hover:text-blurple-500">legal@joinmastodon.org</a>.</p>
        </div>
