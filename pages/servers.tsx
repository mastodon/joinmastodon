      ...
      <Hero mobileImage={serverHeroMobile} desktopImage={serverHeroDesktop}>
        ...
        <p className="sh1 mb-14 max-w-[36ch]">
          <FormattedMessage
            ...
            defaultMessage="Mastodon is not a single website. To use it, you need to make an account with a provider &ndash; we call them <b>servers</b> &ndash; that lets you connect with other people across Mastodon."
            values={{
              b: (text) => <b>{text}</b>,
            }}
          />
