  ...
  <BasicPage>
    <div className="[unicode-bidi:plaintext]">
      ...
      <p>
        ...
        policy. You can view an individual Mastodon server&apos;s privacy policy
        through its website.
      </p>
      ...
      <p className="mt-4">
        You give us consent to send you e-mails when you sign up for one of our
        newsletters.
      </p>
      <p className="mt-4">
        You can unsubscribe from any of our newsletters by using the
        &quot;unsubscribe&quot; link provided in the footer of each e-mail. When
        you unsubscribe, your e-mail address remains in our system by default.
        You can optionally delete all of your data through that link.
      </p>
    </div>
