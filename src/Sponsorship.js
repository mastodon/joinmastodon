        ...
        <div className='sponsors-list--names'>
          <Scrollbars style={{ height: 500 }} renderThumbVertical={renderThumb}>
            ...
            <ul>
              ...
              <li>Johanna B</li>
              <li>Brian</li>
              <li>Emelie Österlund</li>
              <li>Michael Kinyon</li>
              <li>Eszter N. Tót</li>
              ...
              <li>Ryan Rix</li>
              <li>Tim Albers</li>
              <li>Arthur Lemoine</li>
              <li>vpzomtrrfrt</li>
              <li>Lorenzo Vicente</li>
              <li>Patrick Wirth</li>
